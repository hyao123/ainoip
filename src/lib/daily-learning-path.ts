...
export const dailyLearningPath: DayLesson[] = [
  ...
  },
  {
    ...
    phaseName: '基础入门',
    topics: [
      { id: 'intro-cpp', name: 'C++入门', type: 'concept', importance: 'required' },
      { id: 'variables', name: '变量与数据类型', type: 'concept', importance: 'required' },
      { id: 'if-else', name: '选择结构', type: 'concept', importance: 'required' },
      { id: 'for-loop', name: '循环结构', type: 'concept', importance: 'required' },
      { id: 'array-intro', name: '一维数组', type: 'data_structure', importance: 'required' },
      { id: 'struct-intro', name: '结构体', type: 'data_structure', importance: 'recommended' },
      { id: 'string-intro', name: '字符串', type: 'data_structure', importance: 'recommended' },
    ],
