...
export const dailyLearningPath: DayLesson[] = [
  ...
  // ============ 阶段二：基础算法（Day 15-35）============
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'simulation-intro', name: '模拟算法概念', type: 'algorithm', importance: 'required' },
      { id: 'simulation-steps', name: '模拟步骤', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'enumeration', name: '枚举思想', type: 'algorithm', importance: 'required' },
      { id: 'enum-range', name: '枚举范围', type: 'algorithm', importance: 'required' },
      { id: 'enum-optimization', name: '枚举优化', type: 'algorithm', importance: 'recommended' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'recursion-intro', name: '递归概念', type: 'algorithm', importance: 'required' },
      { id: 'recursion-base', name: '递归终止条件', type: 'algorithm', importance: 'required' },
      { id: 'recursion-stack', name: '递归调用栈', type: 'concept', importance: 'recommended' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'recursion-divide', name: '分治思想', type: 'algorithm', importance: 'required' },
      { id: 'recursion-examples', name: '经典递归问题', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'binary-intro', name: '二分思想', type: 'algorithm', importance: 'required' },
      { id: 'binary-search', name: '二分查找', type: 'algorithm', importance: 'required' },
      { id: 'binary-boundary', name: '边界处理', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'binary-check', name: '检验函数', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'greedy-intro', name: '贪心思想', type: 'algorithm', importance: 'required' },
      { id: 'greedy-proof', name: '贪心正确性', type: 'algorithm', importance: 'recommended' },
      { id: 'greedy-examples', name: '经典贪心问题', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'greedy-sort', name: '排序贪心', type: 'algorithm', importance: 'required' },
      { id: 'greedy-interval', name: '区间问题', type: 'algorithm', importance: 'recommended' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'prefix-sum', name: '前缀和概念', type: 'algorithm', importance: 'required' },
      { id: 'prefix-calc', name: '前缀和计算', type: 'algorithm', importance: 'required' },
      { id: 'prefix-range', name: '区间查询', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'difference', name: '差分概念', type: 'algorithm', importance: 'required' },
      { id: 'diff-modify', name: '区间修改', type: 'algorithm', importance: 'required' },
      { id: 'diff-prefix', name: '差分与前缀和', type: 'algorithm', importance: 'recommended' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'fast-power', name: '快速幂原理', type: 'algorithm', importance: 'required' },
      { id: 'fast-power-impl', name: '快速幂实现', type: 'algorithm', importance: 'required' },
      { id: 'mod-power', name: '模幂运算', type: 'algorithm', importance: 'recommended' },
    ],
  ...
  },
  {
    ...
    topics: [
      { id: 'struct-intro', name: '结构体概念', type: 'data_structure', importance: 'required' },
      { id: 'struct-sort', name: '结构体排序', type: 'algorithm', importance: 'required' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'stack-intro', name: '栈概念', type: 'data_structure', importance: 'required' },
      { id: 'stack-stl', name: 'STL stack', type: 'data_structure', importance: 'required' },
      { id: 'stack-app', name: '栈的应用', type: 'algorithm', importance: 'recommended' },
    ],
  ...
  },
  {
    ...
    phaseName: '基础算法',
    topics: [
      { id: 'queue-intro', name: '队列概念', type: 'data_structure', importance: 'required' },
      { id: 'queue-stl', name: 'STL queue', type: 'data_structure', importance: 'required' },
      { id: 'deque', name: '双端队列', type: 'data_structure', importance: 'optional' },
    ],
