...
export const dailySchedule: DailyTask[] = [
  ...
  },
  {
    ...
    problems: [5, 6, 7], // 数字反转, ISBN号码, 标题统计
  ...
  },
  {
    ...
    problems: [63, 64, 65], // 图的邻接表, DFS遍历, BFS遍历
